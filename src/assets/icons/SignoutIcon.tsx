...
const SignoutIcon: React.FC<{ fillColor?: string, width?: number, height?: number }> = (
    {
        ...
        return (
        <svg stroke={fillColor} className="icons" fill={fillColor} strokeWidth="0"
             viewBox="0 0 512 512" height={height + "px"} width={width + "px"}
